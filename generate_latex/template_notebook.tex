...
\lhead{\includegraphics[scale=0.15]{generate_latex/assets/vasconha.jpg} Universidade de Brasília}
\rhead{Sem ela o Vasco não Ganha e a Gente não Coda}

% CONFIG: Title and team name
\title{Cervejeiros do Mendes } % \emoji{balloon} }         
\author{Cauê Trindade, Guga Tonnera $\&$ Vini Araújo}
\date{}

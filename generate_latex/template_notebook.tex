...
\lhead{\includegraphics[scale=0.05]{generate_latex/assets/vasconha.jpg} Universidade de Brasilia}
\rhead{Sem ela o Vasco nao Ganha e a Gente nao Coda}

% CONFIG: Title and team name
\title{Cervejeiros do Mendes } % \emoji{balloon} }         
\author{Caue Trindade, Guga Tonnera $\&$ Vini Araujo}
\date{}


\begin{document}
\begin{figure}[t]
\includegraphics[scale=0.8]{generate_latex/assets/vasconha.jpg}
\centering
\end{figure}
\maketitle
\thispagestyle{fancy}
